...
class EvalCallBack(Callback):
    def __init__(self, eval_function, eval_param_dict,model, eval_dataset, steps_loss, steps_eval,interval=1,eval_start_epoch=1,save_best_ckpt=True,ckpt_directory="./model_resnet/", besk_ckpt_name="best.ckpt", metrics_name="acc"):
    ...
    def end(self, run_context):
        ...
        ax1.legend(loc='best')
        ax2.legend(loc='best')
        plt.savefig(fname="resnet_trainning.png")
